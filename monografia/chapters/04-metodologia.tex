...
orientada ao desenvolvimento de um artefato de \emph{software} e à sua
...
\begin{enumerate}[leftmargin=1.4em,itemsep=0.25em]
  ...
  \item \textbf{E3 --- Implementação}: análise da implementação existente no
        workspace, incluindo a arquitetura em duas camadas, o protocolo
        interno e os mecanismos de robustez documentados no código e no
...
\texttt{seguidor\_de\_linhas\_4camada2-2026-1}, desenvolvido no mesmo
\emph{workspace} do servidor. O projeto destina-se a um robô seguidor de
...
\midrule
Arquitetura definida & E1/E3 & Capítulo~\ref{cap:arquitetura} & 5 \\
Catálogo implementado & E1/E3 & Inventário; Capítulo~\ref{cap:catalogo} & 6 \\
